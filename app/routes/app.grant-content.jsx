...
export const loader = async ({ request }) => {
  ...
  // Fallback direct OAuth authorize URL to prompt Shopify permission screen
  ...
  const authUrl = `https://${shop}/admin/oauth/authorize?client_id=${clientId}&scope=write_products,write_metaobjects,write_metaobject_definitions,write_files,write_content&redirect_uri=${encodeURIComponent(appUrl + "/api/auth")}`;
